			...
			$para  = "jlsantiago691@gmail.com";
				...
				$mensaje = '<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
							...
							<h4 style="font-weight:100; color:#999; padding:0px 20px; text-transform:uppercase">'.$_POST["nombre"].'</h4>

							<h4 style="font-weight:100; color:#999; padding:0px 20px;">De: '.$_POST["email"].'</h4>

							<h4 style="font-weight:100; color:#999; padding:0px 20px">'.$_POST["telefono"].'</h4>

							<h6 style="font-weight:100; color:#999; padding:0px 20px">'.$_POST["mensaje"].'</h6>
				...
				$cabeceras .= 'From: Contacto <contacto@comocrearmipaginaweb.com.mx>' . "\r\n";
